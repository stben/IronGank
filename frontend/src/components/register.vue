...
<mu-container>
  ...
  <div class="img-div">
  <mu-appbar style="width: 100%;" color="#29b6f6">
  ...
  <mu-form ref="form" :model="validateForm" class="formstyle">
    <mu-form-item prop="firstName" :rules="firstnameRules">
      <mu-text-field v-model="validateForm.firstName"  prop="firstName" ref="stuName" placeholder="请输入名字">
      </mu-text-field><br/>
    </mu-form-item>
    <mu-form-item prop="sid" :rules="usernameRules">
      <mu-text-field v-model="validateForm.sid" prop="sid" ref="stu" placeholder="请输入学号">
      </mu-text-field><br/>
    </mu-form-item>
    <mu-form-item prop="password" :rules="passwordRules">
      <mu-text-field v-model="validateForm.password" prop="password" ref="password" :action-icon=
        "visibility ? 'visibility_off' : 'visibility'" :action-click="() => (visibility = !visibility)"
        :type="visibility ? 'text' : 'password'" placeholder="请输入密码">
      </mu-text-field><br/>
    </mu-form-item>
    <mu-form-item prop="tel" :rules="telRules">
    ...
    <mu-form-item prop="verificationCode" :rules="verificationCodeRules">
      <mu-text-field v-model="validateForm.verificationCode" prop="verificationCode" placeholder="请输入手机验证码.">
      </mu-text-field><br/>
    </mu-form-item>
    <mu-form-item class="button-wrapper">
    <mu-button color="#29b6f6" @click="postRegister">注册</mu-button>
