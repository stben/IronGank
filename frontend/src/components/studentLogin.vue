  ...
  <div id="studentLogin">
    ...
    <mu-paper :z-depth="4" class="board">
      ...
      <mu-tabs :value.sync="active" color="white" indicator-color="blue" center>
        ...
        <mu-tab style="color: #78909c" to="/teacher/login">教师</mu-tab>
      </mu-tabs>
      <div v-if="active===0">
        <mu-form ref="form0" :model="validateForm0" class="formstyle">
          <mu-form-item prop="username" :rules="usernameRules0">
            <mu-text-field v-model="validateForm0.username" prop="username" placeholder="学号/手机号" class="input"></mu-text-field>
          </mu-form-item>
          <mu-form-item prop="password" :rules="passwordRules0">
            <mu-text-field type="password" v-model="validateForm0.password" prop="password" placeholder="密码" class="input"></mu-text-field>
          </mu-form-item>
